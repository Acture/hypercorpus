...
- Write the contribution as `dense-started constrained subgraph selection under explicit selector budgets`. The current data does not support a stronger headline like `walk beats dense everywhere`.
