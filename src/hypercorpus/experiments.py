...
from hypercorpus.answering import Answerer, LLMAnswerer, LLMAnswererConfig, SupportsAnswer
...
def _build_runtime_config_payload(
    *,
    ...
    return {
        ...
        "mdr_artifact_manifest": str(mdr_artifact_manifest) if mdr_artifact_manifest is not None else None,
        "sentence_transformer_model": sentence_transformer_model,
        "sentence_transformer_device": sentence_transformer_device,
        "with_e2e": with_e2e,
        "answerer_mode": answerer_mode,
