...
from hypercorpus.store.kvstore.sqlite import SQLiteKVStore
from hypercorpus.utils.jsonl2csv import jsonl_to_csv as jsonl2csv_impl
from hypercorpus.utils.fetch_wiki import fetch_wiki as fetch_wiki_impl
...
utils_app = typer.Typer(
	name="hypercorpus utils",
	help="hypercorpus utilities",
...
def fetch_wiki(
	...
	target_count: int = typer.Option(
		100, "-c", "--count", help="Number of articles to fetch"
	),
	min_char_length: Optional[int] = typer.Option(
		None, help="Minimum character length for article text"
	),
):
	"""
