...
DEFAULT_CACHE_DIR = Path.home() / ".cache" / "webwalker" / "stores"
...
def _question_loader_for_dataset(dataset_name: str):
    from webwalker.datasets.hotpotqa import load_hotpotqa_questions
    from webwalker.datasets.iirc import load_iirc_questions
    from webwalker.datasets.musique import load_musique_questions
    from webwalker.datasets.twowiki import load_2wiki_questions
