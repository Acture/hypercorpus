...
def prepare_2wiki_store(
    ...
    *,
    ...
    try:
        questions_local = _materialize_questions_source(resolved_questions_source, temp_paths=temp_paths)
        ...
        prepared = prepare_store_from_records(
            ...
            normalized_records=_iter_two_wiki_normalized_records(graph_local, id_to_title=id_to_title),
...
def _iter_two_wiki_normalized_records(path: Path, *, id_to_title: dict[str, str]) -> Iterator[dict]:
