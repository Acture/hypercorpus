...
def test_run_hotpotqa_fullwiki_cli_requires_graph_records(hotpotqa_fullwiki_files, tmp_path):
...
def test_run_store_cli_commands_smoke(prepared_iirc_store, prepared_musique_store, prepared_hotpotqa_store, tmp_path):
    runner = CliRunner()
    commands = [
...
def test_merge_new_store_results_cli_smoke(prepared_iirc_store, prepared_musique_store, prepared_hotpotqa_store, tmp_path):
    runner = CliRunner()
    command_specs = [
        ("run-iirc-store", prepared_iirc_store.root, "iirc", "merge-iirc-results"),
        ("run-musique-store", prepared_musique_store.root, "musique", "merge-musique-results"),
        ("run-hotpotqa-store", prepared_hotpotqa_store.root, "hotpot", "merge-hotpotqa-results"),
    ]
