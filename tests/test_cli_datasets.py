...
def test_fetch_2wiki_cli_downloads_question_and_graph(
	two_wiki_archives, tmp_path, monkeypatch
):
...
def test_prepare_2wiki_store_cli_rejects_existing_partial_output(
